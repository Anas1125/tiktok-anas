...
import { BiLoaderCircle, BiSolidAddToQueue, BiSolidCloudUpload } from "react-icons/bi";
...
export default function upload(){
    ...
    const validate = () => {
        ...
        if (!file) {
            setError({ type: 'File', message:'Avideo is required'})
            isError = true
        } else if (!caption) {
    ...
    return(
        ...
        <UploadLayout>
            <div className="w-full mt-[80px] mb-[40px] bg-white shadow-lg rounded-md py-6 md:px-10 px-4">
                ...
                <h2 className="text-gray mt-1">Post a video for your account</h2>
            <div className="mt-8 md:flex gap-6">
                {!fileDisplay ? (
                    ...
                    cursor-pointer
                ">
                    <BiSolidCloudUpload size="40" color="#b3b3b1"></BiSolidCloudUpload>
                    ...
                    <p className="mt-2 text-gray-400 text-[13px]">Up to 30 Min</p>
                        ...
                        {isUploading ? (
                            <div className="absolute flex items-center justify-center z-20 bg-black h-full w-full rounded-[50px] bg-opacity-50">
                                <div className="mx-auto flex items-center justify-center gap-1">
                                    <BiLoaderCircle className="animate-spin" color="#F12B56" size={30}></BiLoaderCircle>
                        ...
                        <video 
                            ...
                            <div className="absolute -bottom-12 flex items-center justify-between z-50 rounded-xl border w-full p-2 border-gray-300">
                                <div className="flex items-center truncate">
                                    <AiOutlineCheckCircle  size="16" className="min-w-[16px]"></AiOutlineCheckCircle>
                                    <p className="text-[11px] pl-1 truncate text-ellipsis">
                                        {file ? file.name: ''}
                                    </p>
                                </div>
                                <button onClick={() => clearVideo ()} className="text-[11px] ml-2 fot-semibold">
                                    Change
                                </button>
                            </div>
                    </div>
                ...
                <div className="mt-4 mb-6">
                    <div className="flex bg-[#F8F8F8] py-4 px-6">
                            <div>
                                <PiKnifeLight className="mr-4" size="20"></PiKnifeLight>
                            </div>
                            <div className="text-semibold text-[15px] mb-1.5p">Divide videos and edit</div>
                            <div className="text-semibold text-[13px] text-gray-400">
                                You can quickly divide videos into multiple parts,
                                remove redundant parts and turn landscape 
                ...
                <div className="mt-5">
                    ...
                    <div className="flex gap-3">
                            ...
                            >
                                {isUploading ? <BiLoaderCircle className="animate-spin" color="#ffffff" size={25}></BiLoaderCircle>: "Post"}
                            </button>
                    </div>
                    {error ? (
