    ...
    return (
        ...
        >
            ...
            >
                        ...
                        <div>
                            ...
                            <div className="flex items-center justify-center sm:mt-6">
                                <label htmlFor="image" className="relative cursor-pointer">
                                    <img className="rounded-full" width="95" 
                            ...
                            <div className="flex items-center justify-center sm:-mt-6">
                                <div className="sm:w-[60%] w-full max-w-md">
                                    ...
                                    <p className={`relative text-[11px] text-gray-500 ${error ? 'mt-1' : 'mt-4'}`}>
                                        Usernames can only contains letters,numbers,underscores, and periods.
                ...
                <div
                    id="ButtonSection"
                    className="absolute p-5 left-0 bottom-0 border-t-gray-300 w-full"
                >
                    {!uploadedImage ? (
                        <div id="UpadateInfoButtons" className="flex items-center justify-end">
                            <button
                                disabled={isUpdating}
                                onClick={() => setIsEditProfileOpen(false)}
