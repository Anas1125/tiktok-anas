        ...
        <>
            <div id={`PostMain-${post.id}`} className="flex border-b py-6">
                ...
                <div className="pl-3 w-full px-4">
                    ...
                    <p className="text-[15px] pb-0.5 break-words md:max-w-[300px]">{post.text}</p>
                    ...
                    <div className="mt-2.5 flex">
                        <div className="relative min-h-[480px] max-h-[580px] flex items-center bg-black rounded-xl cursor-pointer">
                            <video 
                            id={`video-${post.id}`}
                            loop
                            controls
                        ...
                        <PostMainLikes post={post}></PostMainLikes>
                    </div>
                </div>
            </div>
        </>
