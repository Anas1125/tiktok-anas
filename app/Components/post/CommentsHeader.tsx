...
export default function CommentsHeader({ post, params }: CommentsHeaderCompTypes){
    ...
    let { commentsByPost, setCommentByPost } = useCommentStore()
    ...
    useEffect(() =>{
        setCommentByPost(params?.postId)
    ...
    const deletePost = async () => {
        let res = confirm('Are You Sure You Wanyt To Delete This Post')
        if (!res) return
                ...
                <div className="flex items-center">
                    ...
                    <div className="ml-3 pt-0.5">
                            <Link 
                                ...
                                className="relative z-10 text-[17px] font-semibold hover:underliine"
                            >
                            {post?.profile.name}
                            </Link>
