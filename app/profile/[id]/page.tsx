...
export default function profile({ params }: ProfilePageTypes){
    ...
    return(
        ...
        <ClientOnly>
            {currentProfile ? (
                <img className="w-[120px] min-w-[120px] rounded-full" 
        ...
        <div className="ml-5 w-full">
                ...
                {contextUser?.user?.id == params?.id ? (
                    ...
                    >
                        <BsPencil className="mt-0.5 mr-1" size="18"></BsPencil>
